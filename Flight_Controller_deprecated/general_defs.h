...
#define CRITICAL_DELAY_INIT_main_ino 	200
#define CRITICAL_DELAY_LOOP_main_ino 	60

#define METRO_LED_HIGH_INTERVAL 		250 // blinking led 
#define METRO_GENERAL_INTERVAL 			500
#define METRO_LED_LOW_INTERVAL 			1000 // blinking led 
...
#define NUM_OF_THROTTLE_CHANNELS		6
...
#define EXTRA_LEFT_CH					4
#define EXTRA_RIGHT_CH					5
