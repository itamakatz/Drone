/****************************************************************************
* ITG3200_Teensy3.h - ITG-3200/I2C library v0.5 for Arduino                         *
...
* VIO & VDD -> pin 3.3V                                                     *
*****************************************************************************/
#ifndef FIMU_ITG3200_Teensy3_h
#define FIMU_ITG3200_Teensy3_h

#include "Arduino.h"
#include <i2c_t3.h>

#define ITG3200_Teensy3_ADDR_AD0_HIGH  0x69   //AD0=1 0x69 I2C address when AD0 is connected to HIGH (VCC) - default for sparkfun breakout
#define ITG3200_Teensy3_ADDR_AD0_LOW   0x68   //AD0=0 0x68 I2C address when AD0 is connected to LOW (GND)
...
// One device should have pin9 (or bit0) LOW and the other should be HIGH." source: ITG3200_Teensy3 datasheet
